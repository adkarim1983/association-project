        ...
        >
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <p className="text-sm">
                        Groupe 3, en face de la Faculté des Lettres et des Sciences Humaines Ben M’sik,<br />
                        Centre social et économique, Rue Rahmouni Boualam,<br />
                        Casablanca.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <p className="text-sm"><FontAwesomeIcon icon={faPhoneVolume} className="text-white mr-2" /> Fixe : 08 08 55 86 90</p>
                    <p className="text-sm text-white">
